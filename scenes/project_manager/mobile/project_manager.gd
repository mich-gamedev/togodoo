...
const BTN_TEMPLATE = preload("res://scenes/project_manager/mobile/project_template_button.tscn")
...
func _on_new_file_pressed() -> void:
	...
	get_tree().change_scene_to_file("res://scenes/main_refactor/mobile/main_mobile.tscn")
